...
This task updates the live Sepolia `NitroEnclaveVerifier` (`0x7D8EA07DB94128DBEe66bAfa3eBAa9668B413d72`) to use the Boundless RISC Zero image ID for Nitro attestation proofs.
