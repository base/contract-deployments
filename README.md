...
> **👥 For Signers:** Please read the [Signer Guide](https://github.com/base/task-signing-tool/blob/main/README.md) for step-by-step instructions on using the validation UI.
