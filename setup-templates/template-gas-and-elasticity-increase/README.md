...
We typically set the DA footprint gas scalar to allow base fees to rise if and only if the DA usage exceeds the L1 target blob throughput. We use the following formula:
