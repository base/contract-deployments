...
interface UpgradeSelectionProps {
  ...
  onStartValidation: (simulationMethod: SimulationMethod) => void;
}
    ...
    <div style={{ textAlign: 'center' }}>
            ...
            >
              ...
              >
                ...
                <div
                  style={{
                    fontSize: '12px',
                    opacity: selectedWallet === option.id ? 0.8 : 0.6,
                    fontWeight: '500',
                  }}
                >
                  {option.date}
      ...
      {selectedWallet && (
        <div style={{ marginTop: '32px' }}>
          ...
          {/* CSS animation for the bouncing arrow is defined in the main style block below */}

          {selectedSimulationMethod && (
            <button
              onClick={() => onStartValidation(selectedSimulationMethod)}
              style={{
