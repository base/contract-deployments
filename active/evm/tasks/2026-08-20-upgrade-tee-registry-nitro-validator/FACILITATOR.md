...
Guide for deploying the hinted Nitro validator stack and upgrading the Sepolia TEE registry.

## 1. Install dependencies

```bash
cd active/evm/tasks/2026-08-20-upgrade-tee-registry-nitro-validator
make deps
```
...
Expected forward state change: the TEE registry EIP-1967 implementation slot changes from `0xF9Ab55c35cE7Fb183A50E611B63558499130D849` to the implementation in `addresses.json`.
