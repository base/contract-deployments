...
/// @dev Writes individual keys so this can share `addresses.json` with the Cobalt deploys.
contract DeployNitroValidatorStack is Script {
    ...
    function _writeAddresses() internal {
        ...
        vm.writeJson(vm.toString(address(p384Verifier)), addressesJson, ".p384Verifier");
        vm.writeJson(vm.toString(address(certManager)), addressesJson, ".certManager");
        vm.writeJson(vm.toString(address(nitroValidator)), addressesJson, ".nitroValidator");
    }
}
