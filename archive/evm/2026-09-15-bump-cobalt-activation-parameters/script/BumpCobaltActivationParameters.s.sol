...
/// @notice Delays Cobalt by two hours and raises the minimum protocol version on Zeronet.
contract BumpCobaltActivationParameters is MultisigScript {
    ...
    constructor() {
        ...
        currentMinimumProtocolVersion = vm.envUint("CURRENT_MINIMUM_PROTOCOL_VERSION");
        newMinimumProtocolVersion = vm.envUint("NEW_MINIMUM_PROTOCOL_VERSION");
    ...
    function _buildCalls() internal view override returns (Call[] memory) {
        ...
        calls[1] = Call({
            operation: Enum.Operation.Call,
            target: address(protocolVersions),
            data: abi.encodeCall(IProtocolVersions.setMinimumProtocolVersion, (newMinimumProtocolVersion)),
            value: 0
        });
    ...
    function _preCheck() internal view {
        ...
        require(
            protocolVersions.minimumProtocolVersion() == currentMinimumProtocolVersion,
        ...
        require(
            newMinimumProtocolVersion != 0 && newMinimumProtocolVersion <= type(uint128).max,
    ...
    function _postCheck(Vm.AccountAccess[] memory, Simulation.Payload memory) internal view override {
        ...
        require(
            protocolVersions.minimumProtocolVersion() == newMinimumProtocolVersion,
