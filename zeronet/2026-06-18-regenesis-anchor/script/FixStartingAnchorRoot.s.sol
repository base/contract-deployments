...
contract FixStartingAnchorRoot is MultisigScript {
    ...
    function setUp() public {
        ...
        // REGENESIS 2026-06-18: genesis anchor is at L2 block 0, so the original `!= 0` guard is
        // intentionally relaxed. The root guard above still prevents an unset (zero) anchor root.
