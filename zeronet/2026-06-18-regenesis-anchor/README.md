...
Status: PREPARED (regenesis 2026-06-18, Phase E — FALLBACK). Only needed if Phase D activate-multiproof did not already set the genesis-0 anchor. The !=0 block guard in FixStartingAnchorRoot.s.sol is relaxed for the genesis-0 anchor. Cloned from 2026-04-23-fix-starting-anchor-root; needs new addresses + genesis output root.
